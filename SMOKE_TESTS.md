...
- UTC timestamp;
- pass/fail for startup, direct chat, group chat, cards, commands, approvals, long reply, restart, project switching, session navigation, model switching, and bounded-cache cold resume;
