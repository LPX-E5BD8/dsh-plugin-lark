...
- UTC timestamp;
- pass/fail for startup, direct chat, group chat, bounded text attachments, image-history routing, cards, structured input, commands, approvals, long reply, restart, project switching, session navigation, model switching, and bounded-cache cold resume;
